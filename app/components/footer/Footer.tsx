...
export function Footer() {
  return (
    <div className="relative left-[50%] z-10 flex h-20 w-full max-w-(--breakpoint-lg) translate-x-[-50%] items-center justify-between px-6 py-0 sm:px-6 md:fixed md:bottom-0 md:px-10 lg:px-20">
